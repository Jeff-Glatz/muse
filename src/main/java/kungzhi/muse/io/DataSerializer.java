  ...
  public enum MuseElementType
    ...
    public static MuseElementType forNumber(int value) {
      switch (value) {
        ...
        case 1: return LOW_FREQ_ABSOLUTE;
        case 2: return DELTA_ABSOLUTE;
        case 3: return THETA_ABSOLUTE;
        case 4: return ALPHA_ABSOLUTE;
        case 5: return BETA_ABSOLUTE;
        case 6: return GAMMA_ABSOLUTE;
        case 7: return LOW_FREQ_RELATIVE;
        case 8: return DELTA_RELATIVE;
        case 9: return THETA_RELATIVE;
        case 10: return ALPHA_RELATIVE;
        case 11: return BETA_RELATIVE;
        case 12: return GAMMA_RELATIVE;
        case 13: return LOW_FREQ_SESSION_SCORE;
        case 14: return DELTA_SESSION_SCORE;
        case 15: return THETA_SESSION_SCORE;
        case 16: return ALPHA_SESSION_SCORE;
        case 17: return BETA_SESSION_SCORE;
        case 18: return GAMMA_SESSION_SCORE;
        case 19: return TOUCHING_FOREHEAD;
        case 20: return HSI;
        case 21: return IS_GOOD;
        case 22: return BLINK;
        case 23: return JAW_CLENCH;
        default: return null;
      }
    }
  ...
  public  static final class MuseDataCollection extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.MuseDataCollection.class) {
              if (PARSER == null) {
  ...
  public  static final class MuseData extends
    ...
    public enum Datatype
      ...
      public static Datatype forNumber(int value) {
        switch (value) {
          ...
          case 9: return DSP;
          case 10: return COMPUTING_DEVICE;
          case 11: return EEG_DROPPED;
          case 12: return ACC_DROPPED;
          case 13: return CALM_APP;
          case 14: return CALM_ALG;
          case 15: return MUSE_ELEMENTS;
          case 16: return GYRO;
          default: return null;
        }
      }
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.MuseData.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class EEG extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.EEG.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class MuseQuantization extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.MuseQuantization.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class Accelerometer extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.Accelerometer.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class Gyro extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.Gyro.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000010;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.Annotation.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class Battery extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.Battery.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000040;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.MuseVersion.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00002000;
    ...
    public static final class Builder extends
      ...
      public Builder addAllEegLocations(
          java.lang.Iterable<? extends kungzhi.muse.io.DataSerializer.HeadLocations> values) {
        copyOnWrite();
        instance.addAllEegLocations(values);  return this;
      }
      /**
       * <pre>
       * derived from eeg_channel_layout
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.MuseConfig.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class EEG_DroppedSamples extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.EEG_DroppedSamples.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class ACC_DroppedSamples extends
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.ACC_DroppedSamples.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000200;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.ComputingDevice.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000002;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.DSP.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  bitField0_ |= 0x00000002;
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (kungzhi.muse.io.DataSerializer.MuseElement.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
