...
public class MuseHeadband
    ...
    public final void connect() {
        ...
        try {
            connection = apply(() -> (StreamConnection) Connector.open(String.format("btspp://%s:2", device.getBluetoothAddress())),
    ...
    public double getRssi() {
        return apply(() -> (double) RemoteDeviceHelper.readRSSI(device), "Failure reading RSSI");
    }
